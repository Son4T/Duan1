            ...
            <div style="width: 90%; margin-top: 50px;margin-left: 40px; background: #fff; padding: 25px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                ...
                <form method="POST" action="index.php?role=admin&act=StorageProduct" enctype="multipart/form-data" style="display: flex; flex-direction: column;">
                    ...
                    <select name="id_cate" id="id_cate" style="padding: 10px; margin-bottom: 20px; border: 1px solid #ccc; border-radius: 4px;" required>
                        ...
                        <?php 
                        $key_type = isset($_GET['product_type']) ? $_GET['product_type'] : '';
                    ...
                    <textarea id="content" name="content" style="height: 100px;padding: 10px; margin-bottom: 20px; border: 1px solid #ccc; border-radius: 4px;" required></textarea>
                    <label for="description" style="margin-bottom: 10px; color: #555;">Mô tả sản phẩm:</label>
                    <textarea id="description" name="description" style="height: 100px;padding: 10px; margin-bottom: 20px; border: 1px solid #ccc; border-radius: 4px;" required></textarea>
